...
public class WeatherPageViewModel : ViewModelBase
{
    ...
    public ObservableCollection<Forecast> Week { get; set; }

    public ObservableCollection<Forecast> Hours { get; set; }

    private void InitData()
    {
        Week = new ObservableCollection<Forecast>
            {
                new Forecast
                {
        ...
        Hours = new ObservableCollection<Forecast>
            {
                new Forecast
                {
